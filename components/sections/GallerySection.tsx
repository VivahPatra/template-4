      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        >
          <motion.p variants={fadeUp} className="font-sans text-xs tracking-[0.4em] uppercase mb-4 glow-pulse"
            style={{ color: '#3a2018' }}><img src="/assets/lotus.webp" alt="" style={{ width: 34, height: 'auto', display: 'inline', verticalAlign: 'middle', filter: 'brightness(1.4)' }} /> &nbsp; Moments &nbsp; <img src="/assets/lotus.webp" alt="" style={{ width: 34, height: 'auto', display: 'inline', verticalAlign: 'middle', filter: 'brightness(1.4)' }} /></motion.p>
