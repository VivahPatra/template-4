...
export default function GallerySection() {
  ...
  return (
    <section id="gallery" className="py-28 relative overflow-hidden on-pink" style={{ background: 'var(--color-surface)' }}>
      <FlowerOverlay />
      <div className="max-w-6xl mx-auto px-6">
        ...
        >
          <motion.p variants={fadeUp} className="font-sans text-xs tracking-[0.4em] uppercase mb-4 glow-pulse"
            style={{ color: 'var(--color-accent)', opacity: 0.7 }}><img src="/assets/lotus.png" alt="" style={{ width: 34, height: 'auto', display: 'inline', verticalAlign: 'middle', filter: 'brightness(1.4)' }} /> &nbsp; Moments &nbsp; <img src="/assets/lotus.png" alt="" style={{ width: 34, height: 'auto', display: 'inline', verticalAlign: 'middle', filter: 'brightness(1.4)' }} /></motion.p>
