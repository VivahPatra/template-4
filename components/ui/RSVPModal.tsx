...
export default function RSVPModal({ open, onClose, onSend, defaultMessage, brideName, groomName }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4" style={{ background: 'rgba(26,10,16,0.85)', backdropFilter: 'blur(8px)' }} onClick={onClose}>
      <div
        className="relative w-full max-w-md rounded-2xl p-6"
        style={{ background: 'var(--color-bg)', border: '1px solid var(--color-border-strong)', boxShadow: '0 0 60px rgba(233,30,99,0.2), 0 20px 60px rgba(0,0,0,0.3)' }}
      ...
      >
        ...
        <button
          ...
          style={{ background: 'var(--color-accent)', color: '#080f1a' }}
        >
