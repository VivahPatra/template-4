...
const STRIP_ITEMS: StripItem[] = [
  { x: '4%',  size: 64, delay: 0.1, opacity: 0.85,  type: 'lotus' },
  { x: '14%', size: 46, delay: 0.5, opacity: 0.75, type: 'leaf' },
  { x: '24%', size: 72, delay: 0.2, opacity: 0.88, type: 'lotus' },
  { x: '35%', size: 52, delay: 0.7, opacity: 0.78, type: 'leaf' },
  { x: '46%', size: 80, delay: 0.0, opacity: 0.90, type: 'lotus' },
  { x: '57%', size: 50, delay: 0.6, opacity: 0.78, type: 'leaf' },
  { x: '68%', size: 70, delay: 0.3, opacity: 0.50, type: 'lotus' },
  { x: '79%', size: 44, delay: 0.8, opacity: 0.75, type: 'leaf' },
